...
const medicalSpecialties = [
  ...
  { value: "than-kinh", label: "Thần kinh học" },
  { value: "tim-mach", label: "Tim mạch" },
  { value: "ho-hap", label: "Hô hấp" },
  { value: "tieu-hoa", label: "Tiêu hóa-Gan mật" },
  ...
  { value: "giai-phau", label: "Giải phẫu-Giải phẫu bệnh" },
    { value: "hoa-sinh-di-truyen", label: "Hóa sinh-Di truyền" },
    { value: "nhi-khoa", label: "Nhi khoa" },
    { value: "mien-dich-di-ung", label: "Miễn dịch-Dị ứng" },
    { value: "di-truyen", label: "Di truyền" },
    { value: "sinh-ly", label: "Sinh lý-Sinh lý bệnh" },
